...
WidgetMetadata = {
  ...
  globalParams: [
    ...
    {
      name: "sourceOrder",
      title: "源排序配置，默认'douban,360,renren,hanjutv'，可选['360', 'vod', 'tmdb', 'douban', 'tencent', 'youku', 'iqiyi', 'imgo', 'bilibili', 'migu', 'sohu', 'leshi', 'xigua', 'maiduidui', 'aiyifan', 'hongguo', 'renren', 'hanjutv', 'bahamut', 'dandan', 'animeko', 'acfun', 'niconico', 'custom']",
      type: "input",
      placeholders: [
        {
          title: "配置1",
